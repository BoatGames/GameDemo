package org.sobadfish.builduhc.player;
...
import org.sobadfish.builduhc.event.PlayerGameDeathEvent;
import org.sobadfish.builduhc.manager.TotalManager;
import org.sobadfish.builduhc.player.message.ScoreBoardMessage;
...
public class PlayerInfo {
    ...
    public void spawn() {
        ...
        if (getPlayer() instanceof Player) {
            ((Player) getPlayer()).setGamemode(2);
        ...
        for (Map.Entry<Integer, Item> entry : armor.entrySet()) {
            ...
            item.addEnchantment(Enchantment.get(0).setLevel(2));//保护Ⅱ
        }
        ...
        Item item1 = new ItemSwordDiamond();
        item1.addEnchantment(Enchantment.get(13).setLevel(2));
        item1.addEnchantment(Enchantment.get(9).setLevel(2));
        player.getInventory().addItem(item1);
        player.getInventory().addItem(new ItemEnderPearl(1,8));
        player.getInventory().addItem(new ItemPotionSplash(21,4));//喷溅治疗药水
        player.getInventory().addItem(new ItemPotion(13,1));//抗火药水
        player.getInventory().addItem(new ItemSteak(1,64));//牛排
        player.getInventory().addItem(new ItemPotion(16,3));//迅捷Ⅱ药水
        player.getInventory().addItem(new ItemPotionSplash(21,25));//喷溅治疗药水
        ...
        /*Item item1 = new ItemSwordDiamond();
        item1.addEnchantment(Enchantment.get(13));
        item1.addEnchantment(Enchantment.get(9));
        player.getInventory().addItem(item1);*/
