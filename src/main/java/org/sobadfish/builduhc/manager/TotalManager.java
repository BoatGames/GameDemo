...
import org.sobadfish.builduhc.manager.data.PlayerDataManager;
import org.sobadfish.builduhc.manager.data.PlayerTopManager;
import org.sobadfish.builduhc.panel.lib.AbstractFakeInventory;
...
public class TotalManager {
    ...
    public static String getScoreBoardTitle(){
        return TextFormat.colorize('&', plugin.getConfig().getString("scoreboard-title","&eBuildUHC - 药神对决"));
    }
