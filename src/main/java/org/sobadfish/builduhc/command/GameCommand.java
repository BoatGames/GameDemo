package org.sobadfish.builduhc.command;
...
import org.sobadfish.builduhc.room.WorldRoom;
    ...
    public boolean execute(CommandSender commandSender, String s, String[] strings) {
        if(commandSender instanceof Player) {
            if(strings.length == 0) {
                ...
                GameFrom simple = new GameFrom("§aBuild §bUHC §7- §d药神对决",
                        "《药水对决》是一款PVP玩法的小游戏。\n" +
                        "将敌人击败即可获得游戏胜利！" +
                        "" +
                        "",
                ...
                for (String wname : TotalManager.getMenuRoomManager().getNames()) {
                    ...
                    simple.add(new BaseIButton(new ElementButton(TextFormat.colorize('&', "&c药神&b对决 &r- &l&5"+wname+" \n&r\uE175 "+size))) {
                        @Override
                        public void onClick(Player player) {
